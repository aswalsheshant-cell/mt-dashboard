#!/usr/bin/env python3
"""Pytest wrapper to import dashboard disclosure tests from tests/ directory.
...
_spec = importlib.util.spec_from_file_location(
    "test_dashboard_disclosures_impl",
    _ROOT / "tests" / "test_dashboard_disclosures.py"
)
_module = importlib.util.module_from_spec(_spec)
_spec.loader.exec_module(_module)

# Re-export the test classes for pytest discovery
TestDashboardDisclosures = _module.TestDashboardDisclosures  # noqa: F405
TestProvisionalBannerDisplay = _module.TestProvisionalBannerDisplay  # noqa: F405
TestGovernanceDisclosureCompleteness = _module.TestGovernanceDisclosureCompleteness  # noqa: F405
