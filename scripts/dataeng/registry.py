...
METRICS: list[dict] = [
    ...
    dict(name="Primary MRP FY27", path="detail_meta.fyx_primary.FY27.mrp", unit="INR Lakh",
         ...
         source="primary_article CSV column 'Total MRP sales'",
         transformation="fx['_MRP'].sum() in build_dashboard_data.py",
         tabs="(not surfaced)", owner="Sales MIS", basis="GMV_MRP",
         limits="KNOWN DEFECT D13: excludes brand filter and omits Jun-26; understated ~9286.58L."),
