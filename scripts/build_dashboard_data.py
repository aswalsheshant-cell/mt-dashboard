    ...
    for fp in files:
        if fp.suffix.lower() == ".csv":
            try:
                ...
                # low_memory is a C-engine-only option -- pandas raises ValueError if it's
                # passed alongside engine='python', which this bare except silently turned
                # into "skip this file", dropping every real Reliance BC CSV source.
                try:
