...
class TestDataJsRegression:
    def test_primary_fy25_unchanged(self, dash):
        # FY25 has no available raw source (primary.xlsx / Apr'24-Mar'25 feed) to
        # split Central out of, so it stays at the original source-backed 5-zone
        # total. Only FY26's by_zone has a verified Central split.
