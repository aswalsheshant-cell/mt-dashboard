Drop the MONTHLY ship-to primary file here (Direct + Distributor rows, NSV
already allocated to Chain by secondary-driven Cont%).
Headers per _TEMPLATE_Primary_ShipTo.csv. Month label MMM'YY or use MonthStart date.
