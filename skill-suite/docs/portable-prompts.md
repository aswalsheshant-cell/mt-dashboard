...
The canonical skills in `skill-suite/skills/` remain the source of truth. When a rule
changes there, update the matching line here. This file is documentation, not a skill —
it is not installed to any target and carries no frontmatter.
