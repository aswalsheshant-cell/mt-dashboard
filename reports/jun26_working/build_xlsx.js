...
const ocz = loadTsv('offtake_chain_zone.tsv', 3, 15);
const obz = loadTsv('offtake_brand_subcat_zone.tsv', 4, 15);
...
// ---------- KPI DASHBOARD ----------
{
  ...
  set(26, 0, "Note: shared source Grand Totals (unrounded) close Jun'26 at 3,652 Lacs; row-level data in this workbook is rounded to whole Lacs, so sums land within ±5 Lacs (<0.2%).");
  ws['!ref'] = 'A1:Q30';
...
{
  const rows = [
    ["HONASA — MT OFFTAKE & PRIMARY WORKING FILE — JUN'26 CLOSE + Q1 FY27"],
    [''],
    ['HOW THIS FILE WORKS'],
...
// order: READ_ME first
wb.SheetNames = ['READ_ME', 'KPI_Dashboard', 'Q1_FY27_Scorecard', 'Zone_Summary', 'Chain_Summary', 'Brand_SubCat_Summary', 'Primary_Summary', 'May26_External_Workings', 'Slide_Map', 'Offtake_Chain_Zone', 'Offtake_Brand_SubCat_Zone', 'Primary_Zone_Chain', 'Primary_Brand_Monthly'];
wb.Workbook = { CalcPr: { fullCalcOnLoad: true } };
const out = path.join(__dirname, 'MT_Offtake_Primary_Jun26_Working.xlsx');
